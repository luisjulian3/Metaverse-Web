    ...
    <div className='container py-10 sm:min-h-[400px] sm:grid sm:place-items-center'>
        <div className='space-y-6 max-w-xl mx-auto'>
            ...
            <p data-aos="fade-up" data-aos-delay="300" className='text-center sm:px-20'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, fuga quae aliquid at inventore beatae culpa cum totam, iure provident et illo ipsum minus voluptates. Perferendis consequuntur molestiae quibusdam vero!
            </p>
